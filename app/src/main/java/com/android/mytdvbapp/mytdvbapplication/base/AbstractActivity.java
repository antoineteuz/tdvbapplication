...
public abstract class AbstractActivity extends AppCompatActivity implements MenuItem.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.activity_base_layout);// The base layout that contains your navigation drawer.
